...
module SifttterRedux
  ...
  def self.update_config_file
    m = "This version needs to make some config changes. Don't worry; when " \
    "prompted, your current values for existing config options will be " \
    "presented (so it'll be easier to fly through the upgrade)."
    messenger.info(m)
